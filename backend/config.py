"""Kurama App — backend configuration."""
...
# Temporary app-backend downloads and task state.
...
# ─── Connection / proxy ─────────────────────────────────
# The backend respects http_proxy / https_proxy / all_proxy environment values.
